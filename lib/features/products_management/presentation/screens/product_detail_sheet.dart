                        ...
                        children: [
                          ...
                          if (product.description != null &&
                            ...
                            _DetailCard(
                              ...
                              title: 'Description',
                              children: [_NoteRow(text: product.description!)],
                            ),
                            const SizedBox(height: 14),
                          ],
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (label, color, icon) = switch (status.toLowerCase()) {
      'active' ||
      'published' => ('Active', AppColors.success, Icons.check_circle_rounded),
      'draft' => ('Draft', AppColors.warning, Icons.edit_rounded),
      'inactive' ||
      'archived' => ('Inactive', AppColors.textTertiary, Icons.archive_rounded),
