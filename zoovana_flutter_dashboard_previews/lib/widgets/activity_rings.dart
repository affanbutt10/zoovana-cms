    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        return CustomPaint(
          ...
          painter: _RingsPainter(rings: widget.rings, progress: Curves.easeOutCubic.transform(_controller.value)),
        );
      },
    );
  }
...
class _RingsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final radii = [size.width / 2 - strokeWidth / 2, size.width / 2 - strokeWidth * 2.2, size.width / 2 - strokeWidth * 3.6];
                  ...
                  children: [
                    ...
                    Expanded(
                      child: RichText(
                        ...
                        text: TextSpan(
                          style: const TextStyle(fontSize: 10.5, color: Color(0xD9FFFFFF), fontWeight: FontWeight.w600),
                          children: [
                            TextSpan(text: '${r.pct.toInt()}% ', style: const TextStyle(color: CupertinoColors.white, fontWeight: FontWeight.w800)),
