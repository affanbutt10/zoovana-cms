        ...
        itemBuilder: (context, i) {
          ...
          return SizedBox(
            ...
            child: CupertinoContextMenu(
              ...
              child: _UpcomingCard(card: card, accent: accent, accentDark: accentDark, accentGlow: accentGlow),
            ),
          );
        },
      ),
...
class _UpcomingCard extends StatelessWidget {
  ...
  const _UpcomingCard({required this.card, required this.accent, required this.accentDark, required this.accentGlow});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: accentGlow, borderRadius: BorderRadius.circular(100)),
                child: Text(card.tag, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: accentDark)),
              ),
              Container(
                width: 34,
                height: 34,
                decoration: BoxDecoration(color: accentGlow, borderRadius: BorderRadius.circular(11)),
          ...
          Text(card.title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF0B1E5B), letterSpacing: -0.2)),
          const SizedBox(height: 3),
          Text(card.subtitle, style: const TextStyle(fontSize: 11, color: Color(0xFF98A2B3), fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
