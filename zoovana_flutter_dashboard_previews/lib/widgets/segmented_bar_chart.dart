    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(widget.chartLabel,
              style: const TextStyle(fontSize: 16.5, fontWeight: FontWeight.w700, color: Color(0xFF0B1E5B), letterSpacing: -0.3)),
        ),
        CupertinoSlidingSegmentedControl<String>(
          ...
          children: const {
            'week': Padding(padding: EdgeInsets.symmetric(vertical: 6), child: Text('Week', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12))),
            'month': Padding(padding: EdgeInsets.symmetric(vertical: 6), child: Text('Month', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12))),
            'year': Padding(padding: EdgeInsets.symmetric(vertical: 6), child: Text('Year', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12))),
          },
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(widget.chartSub, style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700, color: Color(0xFF98A2B3))),
                  Text(dataset.total, style: const TextStyle(fontSize: 19, fontWeight: FontWeight.w800, color: Color(0xFF0B1E5B), letterSpacing: -0.4)),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(widget.label, style: const TextStyle(fontSize: 9.5, color: Color(0xFF98A2B3), fontWeight: FontWeight.w600)),
      ],
    );
  }
}
